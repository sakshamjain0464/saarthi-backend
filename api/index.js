...
app.post('/ask-question', async (req, res) => {
    const { question, iterinary, language, chatHistory } = req.body;


    prompt = `You are a travel assistant. Below is a travel itinerary in Markdown format that was generated by you. Your task is to answer the follow-up question using. Max character limit of iterinary is 10000 characters.
