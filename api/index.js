...
app.post('/generate-itinerary', async (req, res) => {
    const { from, to, startDate, endDate, numberOfPeople, groupType, additionalInfo, interests, language } = req.body;
...
**Give the answer strictly in ${language} language. Use normal language do not use complex words and keep the language local**
...
4. Also take travel time in account while generating the itinerary.
5. You can also give suggestions to the user if there is any problem with the data provided like days are not enough or locations not provided properly. **You can give suggestions but do not modify the provided data.**
